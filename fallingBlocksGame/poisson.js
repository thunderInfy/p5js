...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'poisson.wast';
  var wasmBinaryFile = 'poisson.wasm';
  var asmjsCodeFile = 'poisson.temp.asm.js';
...
Module['wasmTableSize'] = 227;

Module['wasmMaxTableSize'] = 227;
...
var __GLOBAL__sub_I_poisson_cpp = Module["__GLOBAL__sub_I_poisson_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_poisson_cpp"].apply(null, arguments) };
